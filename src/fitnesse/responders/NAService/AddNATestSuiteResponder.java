...
public class AddNATestSuiteResponder implements Responder {
  ...
  public static Responder makeResponder(Request request, String rootPath) throws Exception {
    ...
    if (requestedFile.isDirectory())
      return new NATestSuiteResponder(resource, requestedFile);
    else
      return new AddNATestSuiteResponder(resource, requestedFile);
  }

  public AddNATestSuiteResponder(String resource, File requestedFile) {
